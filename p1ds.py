...
@timeit
def TDMA():
    """ TriDiagonal Matrix Algorithm Solver Subroutine """
...
parser = argparse.ArgumentParser(
    description="P1DS 1-D conv-diffusion eq solver.")
parser.add_argument('-o', '--output', type=str,
                    default='fileout', help="fileout output file.")
parser.add_argument('-p', '--parameter', type=int,
                    default=1001, help="NX parameter for array lengths.")
parser.add_argument('-i', '--input', nargs='?', type=str,
                    default='parameter.json', help="parameter.prm file for input.")
